...
@NgModule({
  declarations: [
    AppComponent,
    MapComponent,
    ChartCaseComponent, ChartCumComponent, ChartVaxComponent, ChartTestComponent, ChartCatgComponent, ChartAgeComponent,
    InfoPanelComponent, SmallInfoPanelComponent, LoadingPanelComponent, AboutPanelComponent,
    SafeHtmlPipe,
  ],
  imports: [
